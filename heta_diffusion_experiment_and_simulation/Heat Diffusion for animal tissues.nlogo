...
material-type
material-type
"wood" "stone" "iron" "aluminum" "silver" "meat" "other"
5
...
240
419
Heat Diffusion 2.0: Run simulation based in heat diffusivity of animal tissue. Under a range of tem-\n-peratures from 37º C to 0º C. \nIn reference to sfere of 3 cm radius (36 cm volumen)\nin 25 minutes, under water and ice with salt on circulation cricuit.\nEvery tick on NetLogo model is referenced to\nrule-of-thumb in hypothermia 1.1ºC by minute.
12
0.0
1
...
For derived version:
* https://www.sciencedirect.com/science/article/abs/pii/S0260877401000838
Heat diffusion of animal tissues from different type of samples of meats/fish
* Applied principles of hypothermia to transplant organ
* Follow Smith's Chryterion.
